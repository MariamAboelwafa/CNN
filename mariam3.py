...
numberOfImagesToValidate = 15 * 257
...
trainingDataGenerator = trainingDataGenerator.flow_from_directory(trainingDirectory,target_size=(imageWidth, imageHeight),batch_size=numberOfImagesPerBatch,shuffle=True)

# Loading Validation Data...
validationDataGenerator = validationDataGenerator.flow_from_directory(validationDirectory,target_size=(imageWidth,imageHeight),batch_size=numberOfImagesPerBatch,shuffle=False)
print("Data Set loaded!" + '\n')
print("Now Training...")

# Train Your Model
myModel.fit_generator(trainingDataGenerator, steps_per_epoch=numberOfTrainingBatches, epochs=numberOfEpochs, validation_data=validationDataGenerator, validation_steps=numberOfValidationBatches, verbose=1,callbacks=callbacks)


#Save the model

model.save('mariam_model.h5')
